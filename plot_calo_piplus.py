...
from data_piplus import CaloDataset
...
SIZES = [1, 8, 10, 10, 10, 10, 1, 5, 10, 15, 10, 16, 1, 10]
...
def plot_calo_batch(tensor, fp, layer, ncol=8, vmin=1e-2, vmax=None, save_it=True,
    ...
    scale_factor = 1
    plot_sizes = scale_factor * np.array([8, 1, 10, 10, 10, 10, 5 ,1, 15, 10, 16, 19, 10, 1])
    ...
    ndarr = tensor.clamp_(0., 1e6).to('cpu').numpy()
